...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence in self.knowledge:
            if len(sentence.cells) == 0:
                ...
                unique_cells = sentence.cells - new_sentence.cells
                count_difference = sentence.count - new_sentence.count
                new_knowledge.append(Sentence(unique_cells, count_difference))
    ...
    def get_neighbors(self, cell):
        """
        Returns a list of all cells that are neighbors of
        the given cell.
        """
        neighbors = set()
        for i in range(cell[0] - 1, cell[0] + 2):
